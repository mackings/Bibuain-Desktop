        ...
        return Padding(
          ...
          child: Column(
            children: [
              ...
              // Row containing two Expanded widgets side by side
              Expanded(
                child: Row(
                  children: [
                    Expanded(
                                        ...
                                        return ListTile(
                                          ...
                                          subtitle: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Offer Margin: ${NumberFormat('#,##0.00').format(offer.margin)}',
                                                style: GoogleFonts.montserrat(
                                                  fontSize: 12,
                                                ),
                                              ),
                    ...
                    const SizedBox(width: 10), // Add space between the two Expanded widgets
                    Expanded(
                      child: FutureBuilder<List<AccountOffers>>(
                        future: futureOffers,
                        builder: (context, offersSnapshot) {
