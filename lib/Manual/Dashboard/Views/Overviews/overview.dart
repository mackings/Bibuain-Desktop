                        ...
                        children: [
                          ...
                          Table(
                            ...
                            children: [
                              ...
                              ...staff?.assignedTrades.where((trade) {
                                    // Get the assignedAt time as a DateTime object
                                    DateTime assignedAtTime =
                                        DateTime.parse(trade.assignedAt);
                                    // Get the current time and the time 12 hours ago
                                    DateTime now = DateTime.now();
                                    DateTime twelveHoursAgo =
                                        now.subtract(Duration(hours: 12));
                                    // Check if the trade was assigned in the last 12 hours
                                    return assignedAtTime
                                        .isAfter(twelveHoursAgo);
                                  }).map((trade) {
                                    return TableRow(
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              vertical:
                                                  8.0), // Add vertical padding
                                          child: Text(trade.account,
                                              style: GoogleFonts.montserrat()),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              vertical:
                                                  8.0), // Add vertical padding
                                          child: SelectableText(trade.tradeHash,
                                              style: GoogleFonts.montserrat()),
                                        ),
                                      ],
                                    );
